...
<div class="queue_ind_item historyItem <?php  echo ' '.$actionOverallStatus; ?>" did="<?php echo $actionIDHTML; ?>"  actionID="<?php echo $actionID; ?>" onclick=""><?php if($inProgress){ ?><div class="in_progress" style="width: <?php echo $percentageDone; ?>%"></div> <?php } ?> <?php if($stoppingClass != ''){ ?>  <div class="rep_sprite btn_stop_rep_sprite" ><span class = "rep_sprite_backup btn_stop_progress <?php echo $stoppingClass; ?>"  mechanism = "pending" actionID = "<?php echo $actionID; ?>"></span> </div><?php } ?> <?php if($percentageDone<100){ ?><div style="position:relative;"><?php } ?><div class="queue_ind_item_title"><?php $TPLPrepareHistoryBriefTitle = TPLPrepareHistoryBriefTitle($actionHistory); echo $TPLPrepareHistoryBriefTitle; ?></div><div class="timestamp float-right"><?php echo @date(Reg::get('dateFormatYearLess'), $actionHistory['time']); ?></div><?php if($percentageDone<100){ ?></div><?php } ?>
