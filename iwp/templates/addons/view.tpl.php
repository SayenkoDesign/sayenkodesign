...
<div class="result_block shadow_stroke_box purchased_addons">
  <div class="th rep_sprite">
    ...
    <div class="btn_reload rep_sprite" style=" width: 103px; float: left; margin: 7px;"><a class="rep_sprite_backup" <?php if(!$d['isAppRegistered']){ ?>register="no" actionvar="register"<?php } ?>  id="checkNowAddons"  style="width:65px">Check Now</a></div>
	  ...
	  foreach($d['installedAddons'] as  $addon){ 
		...
		?>
          ...
          <div class="row_no_summary">
            ...
            <div class="row_name <?php echo($isBundleClassName); ?>"><?php echo $addon['addon']; ?> <?php echo 'v'.$addon['version']; ?></div>
