...
// Set the Options Array
	   ...
	   $of_options[] = array( "name" => __("Toggles Shortcode", "Avada"),
		...
		$of_options[] = array( "name" => __("Deprecated: Set All Post Items Full Width", "Avada"),
			"desc" => __("This item will be removed in our next update. You can achieve this effect with the new global sidebar options on the sidebar tab by selecting 'none' for each sidebar.", "Avada"),
