...
function executeJobs($callCount = NULL){
	...
	$settings = Reg::get('settings');
	  ...
	  $pendingRequests = DB::getArray("?:history H LEFT JOIN ?:sites S ON H.siteID = S.siteID", "H.historyID, S.IP, S.serverGroup, H.actionID, H.runCondition, H.isPluginResponse, H.retried", $where);
