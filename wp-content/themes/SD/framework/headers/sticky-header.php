...
<div class="sticky-shadow">
	<div class="avada-row">
		...
		<?php if( ! $smof_data['ubermenu'] ): ?>
        	<span class="sticky_free_estimate_button"><a class="button small green" data-target="#free-estimate_11" data-toggle="modal" target="_self" href="javascript:void(0)">GET STARTED</a></span>
        </ul><?php endif; ?>
		</nav>
