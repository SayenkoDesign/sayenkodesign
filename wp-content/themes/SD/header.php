...
<head>
	...
	#sticky-nav span.sticky_free_estimate_button {margin: 17px 0 0 0; float: left ; width: auto;}
	.gform_body .gform_fields li {width:100%}
	
	@media only screen and (max-width: 980px) {
		.button.small.green.mobile_blue_btn {margin:0 !important;}
		...
		#field_9_6 {margin-left:0 !important;}	
	}
	@media only screen and (max-width:568px) {
		.in .gfield_label {font-size:12px;}
	}
	@media only screen and (max-width:480px) {
		.in .gfield_label {font-size:12px; min-height:30px;}
	}
	@media only screen and (max-width:414px) {
		.in .modal-body > h2 {line-height: 30px;}
		.in .gfield_label {margin:0 !important;}
	}
	...
	.gravity-select-parent .select-arrow{height:31px;line-height:31px;}
	...
	@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {
		.avada-select-parent .select-arrow,.select-arrow, 
		.wpcf7-select-parent .select-arrow{height:33px;line-height:33px;}
		.gravity-select-parent .select-arrow{height:31px !important;line-height:31px !important; width:33px !important;}
	...
	<?php endif; ?>
		...
		.gform_wrapper .top_label li.gfield.gf_left_third, .gform_wrapper .top_label li.gfield.gf_middle_third, .gform_wrapper .top_label li.gfield.gf_right_third {display:inline-block; width:32.4%; vertical-align:top; float:left;}
		.gform_wrapper .top_label li.gfield.gf_left_third input.large, .gform_wrapper .top_label li.gfield.gf_left_third input.medium, .gform_wrapper .top_label li.gfield.gf_left_third select.large, .gform_wrapper .top_label li.gfield.gf_left_third select.medium, .gform_wrapper .top_label li.gfield.gf_middle_third input.large, .gform_wrapper .top_label li.gfield.gf_middle_third input.medium, .gform_wrapper .top_label li.gfield.gf_middle_third select.large, .gform_wrapper .top_label li.gfield.gf_middle_third select.medium, .gform_wrapper .top_label li.gfield.gf_right_third input.large, .gform_wrapper .top_label li.gfield.gf_right_third input.medium, .gform_wrapper .top_label li.gfield.gf_right_third select.large, .gform_wrapper .top_label li.gfield.gf_right_third select.medium {width:100%; margin:0px;}
		body .gform_wrapper label.gfield_label + div.ginput_container {margin-top:0;}
		.gravity-select-parent {height:33px !important; width:100% !important;}
		#wrapper .gform_wrapper .gravity-select-parent select {height:33px !important; margin:0;}
		.gform_wrapper select option {padding:0 0.125em;}
		.gravity-select-parent .select-arrow { width: 26px; height:31px; line-height: 31px; border-left: 1px solid #dadada; position: absolute; top: 1px; right: 1px; pointer-events: none; background: #fff; z-index: 10; font-family: IcoMoon; font-size: 9px; text-align: center; }
		
		.gform_wrapper .top_label li.gfield.gf_left_half {clear: left !important; margin-right:0; float:left;}
		.gform_wrapper .top_label li.gfield.gf_left_half {display:inline-block; width:49%;}
		.gform_wrapper .top_label li.gfield.gf_right_half {display:inline-block; float:right; width:49%; margin:0 0 0.6em;}
		.gform_wrapper .top_label li.gfield.gf_left_half input.large, .gform_wrapper .top_label li.gfield.gf_left_half input.medium, .gform_wrapper .top_label li.gfield.gf_left_half select.large, .gform_wrapper .top_label li.gfield.gf_left_half select.medium, .gform_wrapper .top_label li.gfield.gf_right_half input.large, .gform_wrapper .top_label li.gfield.gf_right_half input.medium, .gform_wrapper .top_label li.gfield.gf_right_half select.large, .gform_wrapper .top_label li.gfield.gf_right_half select.medium {width:97%; margin:0;}
		.gform_wrapper .top_label li.gfield.gf_left_half {margin:0 0 0.5em;}
		...
		.gform_wrapper .top_label input.large, .gform_wrapper .top_label select.large, .gform_wrapper .top_label textarea.textarea {max-width:100%; min-width:100%; width:100%;}
		
		.modal-lg {margin:60px auto 0;}
		
		@media only screen and (max-width: 800px) {
			.gform_wrapper .top_label li.gfield.gf_left_half {margin:0 1.6% 0 0;}
		...
		@media only screen and (max-width: 767px) {
			...
			.gform_wrapper .top_label li.gfield.gf_left_half {display:inline-block; width:100%;}
			.gform_wrapper .top_label li.gfield.gf_right_half {display:inline-block; width:100%;}
			.gform_wrapper .top_label li.gfield.gf_left_half {margin:0;}
			.gform_wrapper .top_label li.gfield.gf_middle_third, .gform_wrapper .top_label li.gfield.gf_right_third {margin-left:0px !important;}
			.gform_wrapper .top_label li.gfield.gf_left_third input.large, .gform_wrapper .top_label li.gfield.gf_left_third input.medium, .gform_wrapper .top_label li.gfield.gf_left_third select.large, .gform_wrapper .top_label li.gfield.gf_left_third select.medium, .gform_wrapper .top_label li.gfield.gf_middle_third input.large, .gform_wrapper .top_label li.gfield.gf_middle_third input.medium, .gform_wrapper .top_label li.gfield.gf_middle_third select.large, .gform_wrapper .top_label li.gfield.gf_middle_third select.medium, .gform_wrapper .top_label li.gfield.gf_right_third input.large, .gform_wrapper .top_label li.gfield.gf_right_third input.medium, .gform_wrapper .top_label li.gfield.gf_right_third select.large, .gform_wrapper .top_label li.gfield.gf_right_third select.medium {width:99.8%;}
		}
...
?>
<body <?php body_class( $body_classes ); ?> data-spy="scroll" onload="_googWcmGet('google-phone', '206. 659. 8955.')">
